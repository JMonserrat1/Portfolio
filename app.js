...
const firebaseConfig = {
    apiKey: "AIzaSyBse4TKa6FSqb7HZu80tiE8tI84akh0YCU",
    authDomain: "portfolio-63255.firebaseapp.com",
    projectId: "portfolio-63255",
    storageBucket: "portfolio-63255.appspot.com",
    messagingSenderId: "569671307844",
    appId: "1:569671307844:web:fdf1c8cae94a65d7406211",
    measurementId: "G-72LKG8E58T"
  };
...
document.getElementById('formulario').addEventListener('submit', (event) => {
    ...
    let mensajeEntrada = document.getElementById('mensaje');

    if (mensajeEntrada.value.length) {

    // Si todos los campos son válidos, enviar formulario
    if (!errorNombre.textContent && !emailError.textContent && !mensajeEntrada.textContent) {
        ...
        .then((docRef) => {
            alert('¡Muchas gracias por comunicarte!', docRef.id);
